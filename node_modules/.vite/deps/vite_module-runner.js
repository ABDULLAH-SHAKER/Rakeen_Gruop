...
var createInvokeableTransport = (transport) => {
  ...
  return {
    ...
    disconnect() {
      ...
      }), rpcPromises.clear(), (_a = transport.disconnect) == null ? void 0 : _a.call(transport);
    },
    send(data) {
    ...
    async invoke(name, data) {
      ...
      }, timeout), (_a = timeoutId == null ? void 0 : timeoutId.unref) == null ? void 0 : _a.call(timeoutId)), rpcPromises.set(promiseId, { resolve: resolve2, reject, name, timeoutId }), sendPromise && sendPromise.catch((err) => {
...
var createWebSocketModuleRunnerTransport = (options) => {
  ...
  return {
    ...
    disconnect() {
      clearInterval(pingIntervalId), ws == null ? void 0 : ws.close();
    },
    send(data) {
...
var ModuleRunner = class {
  constructor(options, evaluator = new ESModulesEvaluator(), debug) {
    ...
    if (this.root = root[root.length - 1] === "/" ? root : `${root}/`, this.evaluatedModules = options.evaluatedModules ?? new EvaluatedModules(), this.transport = normalizeModuleRunnerTransport(options.transport), options.hmr !== false) {
      ...
      (_b = (_a = this.transport).connect) == null ? void 0 : _b.call(_a);
  ...
  clearCache() {
    var _a;
    this.evaluatedModules.clear(), (_a = this.hmrClient) == null ? void 0 : _a.clear();
  }
  /**
  ...
  async close() {
    var _a, _b, _c;
    (_a = this.resetSourceMapSupport) == null ? void 0 : _a.call(this), this.clearCache(), this.hmrClient = void 0, this.closed = true, await ((_c = (_b = this.transport).disconnect) == null ? void 0 : _c.call(_b));
  }
  /**
...
${getStack()}`
  ...
  async cachedModule(url, importer) {
    ...
    if (cached)
      (_a = this.debug) == null ? void 0 : _a.call(this, "[module runner] using cached module info for", url);
    else {
  ...
  async getModuleInformation(url, importer, cachedModule) {
    ...
    (_a = this.debug) == null ? void 0 : _a.call(this, "[module runner] fetching", url);
  ...
  async directRequest(url, mod, _callstack) {
    ...
    if ("externalize" in fetchResult) {
      ...
      (_a = this.debug) == null ? void 0 : _a.call(this, "[module runner] externalizing", externalize);
    ...
    this.hmrClient && Object.defineProperty(meta, "hot", {
      ...
      get: () => {
        ...
        return (_a2 = this.debug) == null ? void 0 : _a2.call(this, "[module runner] creating hmr context for", mod.url), hotContext || (hotContext = new HMRContext(this.hmrClient, mod.url)), hotContext;
      },
      set: (value) => {
        hotContext = value;
      }
